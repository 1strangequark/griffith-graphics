...
export class GriffithScene extends Scene {
    ...
    display(context, program_state) {
        ...
        if (this.turn_on_lights)
        {
            ...
            new Light(day_night_sequence.light_position, sun_yellow, day_night_sequence.radius),
            //courtyard Lights
            new Light(vec4(5.2, 5, 5.2, 1), yellow, 0),
            new Light(vec4(7.5, 5, 5.2, 1), yellow, 0),
            new Light(vec4(5.2, 5, -16.2, 1), yellow, 0),
            new Light(vec4(7.5, 5, -16.2, 1), yellow, 0),
            new Light(vec4(13.2, 5, -11.2, 1), yellow, 0),
            new Light(vec4(13.2, 5, 0.2, 1), yellow, 0),
            new Light(vec4(-0.45, 5, -11.2, 1), yellow, 0),
            new Light(vec4(-0.45, 5, 0.2, 1), yellow, 0),
            new Light(vec4(-17.2, 5, -11.2, 1), yellow, 0),
            new Light(vec4(-17.2, 5, 0.2, 1), yellow, 0),
            new Light(vec4(-5.2, 5, 5.2, 1), yellow, 0),
            new Light(vec4(-12.5, 5, 5.2, 1), yellow, 0),
            new Light(vec4(-5.2, 5, -15.2, 1), yellow, 0),
            new Light(vec4(-12.5, 5, -15.2, 1), yellow, 0),
            //Hollywood Lights
            new Light(vec4(-215, 30, 22, 1), yellow, 1000),
            new Light(vec4(-215, 34, -7, 1), yellow, 1000),
            new Light(vec4(-215, 30, -25, 1), yellow, 1000),
